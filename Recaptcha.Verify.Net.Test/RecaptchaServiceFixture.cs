...
//    public static IRecaptchaVerificationResultValidationService CreateServiceWithClient(IOptions<RecaptchaOptions> options, bool v3 = true)
//    {
...
//        return new RecaptchaVerificationResultValidationService(options, recaptchaClientMock.Object, NullLoggerFactory.Instance.CreateLogger<RecaptchaVerificationResultValidationService>());
//    }

//    public static (
//        Mock<Func<ActionExecutingContext, string, ValidationResult, RecaptchaServiceException, IActionResult>> mock,
//        Expression<Func<Func<ActionExecutingContext, string, ValidationResult, RecaptchaServiceException, IActionResult>, IActionResult>> expression) CreateOnRecaptchaServiceException()
//    {
//        var mock = new Mock<Func<ActionExecutingContext, string, ValidationResult, RecaptchaServiceException, IActionResult>>();
//        Expression<Func<Func<ActionExecutingContext, string, ValidationResult, RecaptchaServiceException, IActionResult>, IActionResult>> expression =
//            x => x.Invoke(It.IsAny<ActionExecutingContext>(), It.IsAny<string>(), It.IsAny<ValidationResult>(), It.IsAny<RecaptchaServiceException>());
//        mock.Setup(expression).Returns<IActionResult>(null);
//        return (mock, expression);
//    }

//    public static (
//        Mock<Func<ActionExecutingContext, string, ValidationResult, Exception, IActionResult>> mock,
//        Expression<Func<Func<ActionExecutingContext, string, ValidationResult, Exception, IActionResult>, IActionResult>> expression) CreateOnException()
//    {
//        var mock = new Mock<Func<ActionExecutingContext, string, ValidationResult, Exception, IActionResult>>();
//        Expression<Func<Func<ActionExecutingContext, string, ValidationResult, Exception, IActionResult>, IActionResult>> expression =
//            x => x.Invoke(It.IsAny<ActionExecutingContext>(), It.IsAny<string>(), It.IsAny<ValidationResult>(), It.IsAny<Exception>());
//        mock.Setup(expression).Returns<IActionResult>(null);
//        return (mock, expression);
//    }

//    public static (
//        Mock<Func<ActionExecutingContext, string, ValidationResult, IActionResult>> mock,
//        Expression<Func<Func<ActionExecutingContext, string, ValidationResult, IActionResult>, IActionResult>> expression) CreateOnVerificationFailed()
//    {
//        var mock = new Mock<Func<ActionExecutingContext, string, ValidationResult, IActionResult>>();
//        Expression<Func<Func<ActionExecutingContext, string, ValidationResult, IActionResult>, IActionResult>> expression =
//            x => x.Invoke(It.IsAny<ActionExecutingContext>(), It.IsAny<string>(), It.IsAny<ValidationResult>());
//        mock.Setup(expression).Returns<IActionResult>(null);
//        return (mock, expression);
//    }

//    public static (
//        Mock<Func<ActionExecutingContext, string, ValidationResult, RecaptchaServiceException, Exception, IActionResult>> mock,
//        Expression<Func<Func<ActionExecutingContext, string, ValidationResult, RecaptchaServiceException, Exception, IActionResult>, IActionResult>> expression) CreateOnReturnBadRequest()
//    {
//        var mock = new Mock<Func<ActionExecutingContext, string, ValidationResult, RecaptchaServiceException, Exception, IActionResult>>();
//        Expression<Func<Func<ActionExecutingContext, string, ValidationResult, RecaptchaServiceException, Exception, IActionResult>, IActionResult>> expression =
//            x => x.Invoke(It.IsAny<ActionExecutingContext>(), It.IsAny<string>(), It.IsAny<ValidationResult>(), It.IsAny<RecaptchaServiceException>(), It.IsAny<Exception>());
//        mock.Setup(expression).Returns<IActionResult>(null);
//        return (mock, expression);
//    }

//    public static (
//        Mock<IRecaptchaVerificationResultValidationService> serviceMock,
//        Expression<Func<IRecaptchaVerificationResultValidationService, Task<ValidationResult>>> verifyWithScoreFromAttribute,
//        Expression<Func<IRecaptchaVerificationResultValidationService, Task<ValidationResult>>> verifyWithoutScoreFromAttribute) CreateService(bool checkResult = false) =>
//        CreateService(checkResult, null);

//    public static (
//        Mock<IRecaptchaVerificationResultValidationService> serviceMock,
//        Expression<Func<IRecaptchaVerificationResultValidationService, Task<ValidationResult>>> verifyWithScoreFromAttribute,
//        Expression<Func<IRecaptchaVerificationResultValidationService, Task<ValidationResult>>> verifyWithoutScoreFromAttribute) CreateService(Type exceptionType) =>
//        CreateService(false, exceptionType);

//    private static (
//        Mock<IRecaptchaVerificationResultValidationService> serviceMock,
//        Expression<Func<IRecaptchaVerificationResultValidationService, Task<ValidationResult>>> verifyWithScoreFromAttribute,
//        Expression<Func<IRecaptchaVerificationResultValidationService, Task<ValidationResult>>> verifyWithoutScoreFromAttribute) CreateService(bool checkResult, Type? exceptionType)
//    {
//        var setups = new List<Moq.Language.Flow.ISetup<IRecaptchaVerificationResultValidationService, Task<ValidationResult>>>();

//        var recaptchaService = new Mock<IRecaptchaVerificationResultValidationService>();
...
//        Expression<Func<IRecaptchaVerificationResultValidationService, Task<ValidationResult>>> verifyWithoutScoreFromAttribute =
...
//    public static (ActionExecutingContext context, ActionExecutionDelegate next) CreateActionExecutingContext(IRecaptchaVerificationResultValidationService? recaptchaService = null, RecaptchaOptions? options = null)
//    {
...
//    private static HttpContextMock CreateHttpContext(IRecaptchaVerificationResultValidationService? recaptchaService, RecaptchaOptions? options, string paramName, string tokenValue)
//    {
